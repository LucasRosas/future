...
function mudaestilo(a, b) {
    ...
    depois = `<script type="module">        import renderMathInElement from "https://cdn.jsdelivr.net/npm/katex@0.12.0/dist/contrib/auto-render.mjs"; renderMathInElement(document.getElementById('preview')); renderMathInElement(document.getElementById('preview'), { delimiters: [{ left: "$$", right:        "$$", display: true }, { left: "\\[", right: "\\]", display: true }, { left: "\\(", right: "\\)", display: false }] }); document.addEventListener("change", function () { renderMathInElement(document.getElementById('preview'), { strict: true });        });    </script><script src="https://lucasrosas.github.io/future/js/javas.js"></script><script>estilo = ${JSON.stringify(estilo)}</script></body></html>`
}
